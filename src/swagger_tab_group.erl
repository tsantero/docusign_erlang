-module(swagger_tab_group).

-export([encode/1]).

-export_type([swagger_tab_group/0]).

-type swagger_tab_group() ::
    #{ 'anchorCaseSensitive' => binary(),
       ...
       'groupLabel' => binary(),
       'groupLabelMetadata' => swagger_property_metadata:swagger_property_metadata(),
       'groupRule' => binary(),
       'groupRuleMetadata' => swagger_property_metadata:swagger_property_metadata(),
       'height' => binary(),
       'heightMetadata' => swagger_property_metadata:swagger_property_metadata(),
       'maximumAllowed' => binary(),
       'maximumAllowedMetadata' => swagger_property_metadata:swagger_property_metadata(),
       'mergeField' => swagger_merge_field:swagger_merge_field(),
       'minimumRequired' => binary(),
       'minimumRequiredMetadata' => swagger_property_metadata:swagger_property_metadata(),
       'pageNumber' => binary(),
       ...
       'tabScope' => binary(),
       'tabScopeMetadata' => swagger_property_metadata:swagger_property_metadata(),
       'tabType' => binary(),
...
encode(#{ 'anchorCaseSensitive' := AnchorCaseSensitive,
          ...
          'groupLabelMetadata' := GroupLabelMetadata,
          'groupRule' := GroupRule,
          'groupRuleMetadata' := GroupRuleMetadata,
          'height' := Height,
          'heightMetadata' := HeightMetadata,
          'maximumAllowed' := MaximumAllowed,
          'maximumAllowedMetadata' := MaximumAllowedMetadata,
          'mergeField' := MergeField,
          'minimumRequired' := MinimumRequired,
          'minimumRequiredMetadata' := MinimumRequiredMetadata,
          ...
          'tabScope' := TabScope,
          'tabScopeMetadata' := TabScopeMetadata,
          'tabType' := TabType,
