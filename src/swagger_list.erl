...
-type swagger_list() ::
    #{ 'anchorCaseSensitive' => binary(),
       ...
       'listSelectedValueMetadata' => swagger_property_metadata:swagger_property_metadata(),
...
encode(#{ 'anchorCaseSensitive' := AnchorCaseSensitive,
          ...
          'listSelectedValueMetadata' := ListSelectedValueMetadata,
