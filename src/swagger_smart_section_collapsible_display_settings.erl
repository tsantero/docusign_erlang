-module(swagger_smart_section_collapsible_display_settings).

-export([encode/1]).

-export_type([swagger_smart_section_collapsible_display_settings/0]).

-type swagger_smart_section_collapsible_display_settings() ::
    #{ 'arrowClosed' => binary(),
       'arrowColor' => binary(),
