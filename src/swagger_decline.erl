-module(swagger_decline).

-export([encode/1]).

-export_type([swagger_decline/0]).

-type swagger_decline() ::
    #{ 'anchorCaseSensitive' => binary(),
       ...
       'buttonText' => binary(),
       'buttonTextMetadata' => swagger_property_metadata:swagger_property_metadata(),
       ...
       'declineReason' => binary(),
       'declineReasonMetadata' => swagger_property_metadata:swagger_property_metadata(),
       'documentId' => binary(),
...
encode(#{ 'anchorCaseSensitive' := AnchorCaseSensitive,
          ...
          'buttonTextMetadata' := ButtonTextMetadata,
          ...
          'declineReasonMetadata' := DeclineReasonMetadata,
